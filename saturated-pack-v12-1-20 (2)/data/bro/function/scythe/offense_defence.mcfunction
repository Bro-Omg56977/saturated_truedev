...
execute as @e[tag=offensedefenceeffect] at @s run title @s actionbar "§9Two Souls has been consumed"
execute as @e[tag=offensedefenceeffect] run scoreboard players remove @s soul_count 2
