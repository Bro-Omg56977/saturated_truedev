...
execute as @e[tag=rageeffect] run effect give @s minecraft:strength 10 0 false
execute as @e[tag=rageeffect] run effect give @s minecraft:speed 10 0 false
execute as @e[tag=rageeffect] at @s run effect give @e[tag=!rageeffect,distance=..10] slowness 10 1 false
execute as @e[tag=rageeffect] at @s run effect give @e[tag=!rageeffect,distance=..10] weakness 10 1 false
execute as @e[tag=rageeffect] at @s run title @s actionbar "§1One Soul has been consumed"
execute as @e[tag=rageeffect] run scoreboard players remove @s soul_count 1
