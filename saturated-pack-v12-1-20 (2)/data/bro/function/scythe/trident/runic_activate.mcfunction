...
execute as @e[tag=runiceffect] at @s run title @s actionbar "§cAll Souls have been consumed"
execute as @e[tag=runiceffect] run scoreboard players remove @s soul_count 10
