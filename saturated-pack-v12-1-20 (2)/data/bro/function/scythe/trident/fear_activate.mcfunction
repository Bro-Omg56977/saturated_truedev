...
execute as @e[tag=fearprojectile,tag=!feareffect] at @s run effect give @s minecraft:darkness 10 1
execute as @e[tag=fearprojectile,tag=!feareffect] at @s run effect give @s minecraft:slowness 10 1
execute as @e[tag=fearprojectile,tag=!feareffect] at @s run effect give @s minecraft:weakness 10 1
execute as @e[tag=fearprojectile,tag=!feareffect] at @s run effect give @s minecraft:mining_fatigue 10 4
