...
#runs some particles
execute as @e[tag=conduitprojectile] at @s run particle minecraft:nautilus ~0.2 ~1 ~0.2 0 0 0 0.1 10
execute as @e[tag=conduitprojectile] at @s run particle minecraft:nautilus ~-0.2 ~1 ~0.2 0 0 0 0.1 10
execute as @e[tag=conduitprojectile] at @s run particle minecraft:nautilus ~ ~1 ~ 0 0 0 0.1 10
execute as @e[tag=conduitprojectile] at @s run particle minecraft:nautilus ~ ~0.6 ~ 0 0 0 0.1 10
