...
execute as @e[tag=vaultingeffect] run effect give @s minecraft:speed 10 0 true
execute as @e[tag=vaultingeffect] run effect give @s minecraft:jump_boost 10 0 true
execute as @e[tag=vaultingeffect] at @s run effect give @e[tag=!vaultingeffect,distance=..10] minecraft:slowness 10 1 false
execute as @e[tag=vaultingeffect] at @s run title @s actionbar "§1One Soul has been consumed"
execute as @e[tag=vaultingeffect] run scoreboard players remove @s soul_count 1
