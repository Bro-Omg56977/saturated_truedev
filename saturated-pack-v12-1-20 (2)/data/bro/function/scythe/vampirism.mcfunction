...
execute as @e[tag=vampirismeffect] run effect give @s minecraft:regeneration 10 1 true
execute as @e[tag=vampirismeffect] run effect give @s minecraft:strength 10 1 true
execute as @e[tag=vampirismeffect] at @s run effect give @e[tag=!vampirismeffect,distance=..10] wither 10 0 false
execute as @e[tag=vampirismeffect] at @s run effect give @e[tag=!vampirismeffect,distance=..10] weakness 10 0 false
