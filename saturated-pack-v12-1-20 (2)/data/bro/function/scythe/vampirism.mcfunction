...
execute as @e[tag=vampirismeffect] run effect give @s minecraft:regeneration 10 2 true
execute as @e[tag=vampirismeffect] run effect give @s minecraft:strength 10 2 true
