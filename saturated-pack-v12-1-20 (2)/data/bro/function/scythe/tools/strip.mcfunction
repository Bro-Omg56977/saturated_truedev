...
execute as @e[tag=satstripmineeffect] at @s run title @s actionbar "§5Five Souls has been consumed"
execute as @e[tag=satstripmineeffect] run scoreboard players remove @s soul_count 5
