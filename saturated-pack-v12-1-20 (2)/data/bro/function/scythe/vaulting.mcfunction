...
execute as @e[tag=vaultingeffect] run effect give @s minecraft:speed 10 4 true
execute as @e[tag=vaultingeffect] run effect give @s minecraft:jump_boost 10 4 true
