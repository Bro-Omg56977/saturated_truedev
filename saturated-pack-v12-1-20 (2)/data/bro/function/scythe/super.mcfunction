...
execute as @e[tag=supereffect] run effect give @s minecraft:saturation 20 4 false
execute as @e[tag=supereffect] run effect give @s minecraft:resistance 20 4 false
execute as @e[tag=supereffect] run effect give @s minecraft:strength 20 4 false
execute as @e[tag=supereffect] run effect give @s minecraft:speed 20 4 false
execute as @e[tag=supereffect] run effect give @s minecraft:slow_falling 20 1 false
execute as @e[tag=supereffect] at @s run tellraw @s "§5Five Souls has been consumed"
execute as @e[tag=supereffect] run scoreboard players remove @e soul_count 5
