...
execute as @e[tag=auspiciouseffect] at @s run effect give @s minecraft:resistance 15 0 true
execute if score @s auspicious_randomizer matches 1 run execute as @e[tag=auspiciouseffect] at @s run effect give @s minecraft:regeneration 15 2 true
execute if score @s auspicious_randomizer matches 2 run execute as @e[tag=auspiciouseffect] at @s run effect give @s minecraft:strength 15 2 true
execute if score @s auspicious_randomizer matches 3 run execute as @e[tag=auspiciouseffect] at @s run effect give @s minecraft:saturation 15 2 true
execute if score @s auspicious_randomizer matches 4 run execute as @e[tag=auspiciouseffect] at @s run effect give @s minecraft:speed 15 2 true
execute if score @s auspicious_randomizer matches 5 run execute as @e[tag=auspiciouseffect] at @s run effect give @s minecraft:haste 15 2 true
execute if score @s auspicious_randomizer matches 6 run execute as @e[tag=auspiciouseffect] at @s run effect give @s minecraft:absorption 15 2 true
execute if score @s auspicious_randomizer matches 7 run execute as @e[tag=auspiciouseffect] at @s run effect give @s minecraft:health_boost 15 2 true
execute as @e[tag=auspiciouseffect] at @s run title @s actionbar "§9Two Souls has been consumed"
execute as @e[tag=auspiciouseffect] run scoreboard players remove @s soul_count 2
