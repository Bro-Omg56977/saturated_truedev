...
execute as @e[tag=fauxshoteffect] at @s run effect give @s minecraft:resistance 25 4 true
execute as @e[tag=fauxshoteffect] at @s run effect give @s minecraft:regeneration 20 4 true
execute as @e[tag=fauxshoteffect] at @s run effect give @s minecraft:strength 20 4 true
execute as @e[tag=fauxshoteffect] at @s run effect give @s minecraft:saturation 20 4 true
execute as @e[tag=fauxshoteffect] at @s run title @s actionbar "§5Five Souls has been consumed"
execute as @e[tag=fauxshoteffect] run scoreboard players remove @s soul_count 5
