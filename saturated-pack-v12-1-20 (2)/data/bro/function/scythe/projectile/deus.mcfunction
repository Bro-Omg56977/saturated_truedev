...
execute as @e[tag=machinaeffect] at @s run title @s actionbar "§cAll Souls has been consumed"
execute as @e[tag=machinaeffect] run scoreboard players remove @s soul_count 10
