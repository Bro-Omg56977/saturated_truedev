...
execute as @e[tag=gratifyeffect] at @s run effect give @s minecraft:regeneration 10 2 true
execute as @e[tag=gratifyeffect] at @s run effect give @s minecraft:instant_health 1 1 false
execute as @e[tag=gratifyeffect] at @s run tellraw @s "§1One Soul has been consumed"
execute as @e[tag=gratifyeffect] run scoreboard players remove @e soul_count 1
