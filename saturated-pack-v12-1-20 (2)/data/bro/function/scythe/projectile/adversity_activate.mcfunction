...
execute as @e[tag=adversityarrow,tag=!adversityeffect] as @s at @s if score @s adversity_randomizer matches 1 run effect give @s minecraft:mining_fatigue 15 3
execute as @e[tag=adversityarrow,tag=!adversityeffect] as @s at @s if score @s adversity_randomizer matches 2 run effect give @s minecraft:hunger 15 3
execute as @e[tag=adversityarrow,tag=!adversityeffect] as @s at @s if score @s adversity_randomizer matches 3 run effect give @s minecraft:weakness 15 3
execute as @e[tag=adversityarrow,tag=!adversityeffect] as @s at @s if score @s adversity_randomizer matches 4 run effect give @s minecraft:slowness 15 3
execute as @e[tag=adversityarrow,tag=!adversityeffect] as @s at @s if score @s adversity_randomizer matches 5 run effect give @s minecraft:darkness 15 3
execute as @e[tag=adversityarrow,tag=!adversityeffect] as @s at @s if score @s adversity_randomizer matches 6 run effect give @s minecraft:nausea 15 3
