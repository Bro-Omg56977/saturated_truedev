...
execute as @e[tag=infectarrow,tag=!infecteffect,type=!#minecraft:undead] at @s run summon area_effect_cloud ~ ~ ~ {Particle:{type:block,block_state:{Name:slime_block}},Radius:5,RadiusPerTick:0.001,Duration:400,potion_contents:{custom_color:6192150,potion:poison,custom_effects:[{id:poison,duration:200,amplifier:4,show_particles:1b}]}}
execute as @e[tag=infectarrow,tag=!infecteffect,type=#minecraft:undead] at @s run summon area_effect_cloud ~ ~ ~ {Particle:{type:block,block_state:{Name:black_concrete_powder}},Radius:5,RadiusPerTick:-0.001,Duration:400,potion_contents:{custom_color:1908001,custom_effects:[{id:wither,duration:200,amplifier:4,show_particles:1b}]}}
