#particles ig
execute as @e[type=marker,tag=sat.aquaboss.summonphase3.placeholder] at @s run particle end_rod ~ ~ ~ 0 0 0 .02 15 force @a[distance=..32]
execute as @e[type=marker,tag=sat.aquaboss.summonphase3.placeholder] at @s run particle glow ~ ~ ~ 0 0 0 .02 15 force @a[distance=..32]
...
execute as @e[tag=sat.aquaboss.summonphase3.placeholder,type=marker] run execute at @s run tp @s ~ ~-.30 ~
