#particles ig
execute as @e[type=marker,tag=sat.aquaboss.summonphase1.placeholder] at @s run particle end_rod ~ ~ ~ 0 0 0 .01 15 force @a[distance=..32]
execute as @e[type=marker,tag=sat.aquaboss.summonphase1.placeholder] at @s run particle glow ~ ~ ~ 0 0 0 .01 15 force @a[distance=..32]
