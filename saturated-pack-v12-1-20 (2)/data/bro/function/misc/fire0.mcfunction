...
#fire random nearby
execute as @e[tag=bropresentinvoid] at @s if score @s bro.firerandomizer.2 matches 1 run fill ~10 ~ ~-9 ~10 ~ ~-9 fire replace air
...
execute as @e[tag=bropresentinvoid] at @s if score @s bro.firerandomizer.2 matches 2 run fill ~-5 ~ ~-2 ~-5 ~ ~-2 fire replace air
...
execute as @e[tag=bropresentinvoid] at @s if score @s bro.firerandomizer.2 matches 3 run fill ~4 ~ ~-7 ~14 ~ ~-7 fire replace air
...
execute as @e[tag=bropresentinvoid] at @s if score @s bro.firerandomizer.2 matches 4 run fill ~-2 ~ ~4 ~-2 ~ ~4 fire replace air
...
execute as @e[tag=bropresentinvoid] at @s if score @s bro.firerandomizer.2 matches 5 run fill ~4 ~ ~5 ~4 ~ ~5 fire replace air
...
execute as @e[tag=bropresentinvoid] at @s if score @s bro.firerandomizer.2 matches 6 run fill ~-8 ~ ~11 ~-8 ~ ~11 fire replace air
