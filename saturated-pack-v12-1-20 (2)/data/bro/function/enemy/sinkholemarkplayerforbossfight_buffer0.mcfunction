...
execute as @e[tag=satsinkholebossplayer] at @s run execute if score @s sat.sinkholeboss.0 matches 1 run schedule function bro:enemy/sinkholemarkplayerforbossfight_buffer 2s replace
