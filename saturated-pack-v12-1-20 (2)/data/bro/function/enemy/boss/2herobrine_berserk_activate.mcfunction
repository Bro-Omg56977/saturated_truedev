...
execute as @e[tag=herobrineberserk3] at @s run effect give @s speed 5 2 true
execute as @e[tag=herobrineberserk3] at @s run effect give @s resistance 5 1 true
execute as @e[tag=herobrineberserk3] at @s run effect give @s strength 5 1 true
