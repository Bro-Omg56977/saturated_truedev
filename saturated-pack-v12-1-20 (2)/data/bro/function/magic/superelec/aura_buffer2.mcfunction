...
execute as @e[type=marker,tag=sat.superelec.auradecor,tag=!sat.superelec.auradecor2,tag=!sat.superelec.auradecor.modified] at @s run spreadplayers ~ ~ 0 20 false @e[type=marker,tag=sat.superelec.auradecor,tag=!sat.superelec.auradecor.modified,tag=!sat.superelec.auradecor2]
execute as @e[type=marker,tag=sat.superelec.auradecor2,tag=!sat.superelec.auradecor.modified] at @s run spreadplayers ~ ~ 0 20 under 60 false @e[type=marker,tag=sat.superelec.auradecor2,tag=!sat.superelec.auradecor.modified]
