...
execute as @e[type=bat,tag=sat.superelec.bomb] at @s run execute as @e[distance=2.5..5,tag=!sat.superelecbomb.immune] run damage @s 15 minecraft:lightning_bolt by @a[sort=nearest,limit=1]
execute as @e[type=bat,tag=sat.superelec.bomb] at @s run execute as @e[distance=..2.5,tag=!sat.superelecbomb.immune] run damage @s 30 minecraft:lightning_bolt by @a[sort=nearest,limit=1]
