...
execute as @e[tag=sat.aquaboss.activate.4] at @s run execute store result score @s sat.aquaboss.attackchances run random value 1..4
...
execute as @e[tag=sat.aquaboss.activate.4] at @s run execute if score @s sat.aquaboss.attackchances matches 4 run tag @s[tag=!sat.elecaura.user] add sat.elecaura.user
execute as @e[tag=sat.aquaboss.activate.4] at @s run execute if score @s sat.aquaboss.attackchances matches 4 run function bro:magic/superelec/aura_start
