...
execute as @e[tag=sattimeacceleffect] run schedule function bro:magic/timeaccel_buffer0 10 replace
execute as @e[tag=sattimeacceleffect] run schedule function bro:magic/timeaccel_stop 360s replace