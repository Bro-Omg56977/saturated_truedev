...
execute as @e[tag=witchanimate4] at @s run summon witch ~ ~ ~ {Glowing:1b,Team:"golemancy",PersistenceRequired:1b,Patrolling:1b,Tags:["summonedbyplayer"],CustomName:"Witch Defender",equipment:{feet:{id:leather_boots,count:1},legs:{id:leather_leggings,count:1},chest:{id:diamond_chestplate,count:1},head:{id:leather_helmet,count:1},mainhand:{id:air,count:1},offhand:{id:air,count:1}},drop_chances:{feet:0.000,legs:0.000,chest:0.000,head:0.000,mainhand:0.000,offhand:0.000}}
execute as @e[tag=witchanimate4] run schedule function bro:magic/basic/summon_distract 5 replace
