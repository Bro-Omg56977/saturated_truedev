...
execute as @e[tag=witchanimate] if entity @s[tag=witchanimate] run schedule function bro:magic/basic/deplete 4s
execute as @e[tag=witchanimate4] if entity @s[tag=witchanimate4] run tag @s add sattarget
execute as @e[tag=witchanimate4] if entity @s[tag=witchanimate4] run schedule function bro:magic/basic/witchsumm_activate 5
