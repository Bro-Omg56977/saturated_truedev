...
execute as @e[tag=babelanimate] if entity @s[tag=babelanimate] run schedule function bro:magic/basic/deplete 4s
...
execute as @e[tag=babelanimate4] if entity @s[tag=babelanimate4] run execute store result score @s babelsuper_randomizer run random value 1..5
execute as @e[tag=babelanimate4] if entity @s[tag=babelanimate4] run schedule function bro:magic/basic/babelsumm_activate 5
