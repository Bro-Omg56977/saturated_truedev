...
execute as @e[tag=illageanimate4] at @s run summon vindicator ~ ~ ~ {Johnny:1b,CustomName:'[{"text":"Doruuk Prime"}]',Health:100,PersistenceRequired:1b,Tags:["summonedbyplayer"],Team:golemancy,Patrolling:1b,PatrolLeader:1b,HandItems:[{id:iron_axe,components:{enchantments:{levels:{"bro:magic/basic/pillager_summon":1}}},count:1},{id:air,count:1}],ArmorItems:[{id:leather_boots,count:1},{id:leather_leggings,count:1},{id:diamond_chestplate,count:1},{id:leather_helmet,count:1}],HandDropChances:[0f,0f],ArmorDropChances:[0f,0f,0f,0f],attributes:[{id:"generic.max_health",base:100f}]}
