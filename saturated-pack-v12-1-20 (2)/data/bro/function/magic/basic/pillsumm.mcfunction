...
execute as @e[tag=pillageranimate] if entity @s[tag=pillageranimate] run schedule function bro:magic/basic/deplete 4s
execute as @e[tag=pillageranimate4] if entity @s[tag=pillageranimate4] run tag @s add sattarget
execute as @e[tag=pillageranimate4] if entity @s[tag=pillageranimate4] run schedule function bro:magic/basic/pillsumm_activate 5
