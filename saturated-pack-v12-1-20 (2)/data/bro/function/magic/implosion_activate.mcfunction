...
execute as @e[tag=implosion2] unless entity @s[type=#minecraft:undead] run effect give @s instant_damage 1 1
execute as @e[tag=implosion2] if entity @s[type=#minecraft:undead] run effect give @s instant_health 1 1
execute as @e[tag=implosion3] unless entity @s[type=#minecraft:undead] run effect give @s instant_damage 1 2
execute as @e[tag=implosion3] if entity @s[type=#minecraft:undead] run effect give @s instant_health 1 2
execute as @e[tag=implosion4] unless entity @s[type=#minecraft:undead] run effect give @s instant_damage 1 2
execute as @e[tag=implosion4] if entity @s[type=#minecraft:undead] run effect give @s instant_health 1 2
