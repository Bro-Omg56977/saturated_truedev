...
execute as @e[tag=evilwave,type=#bro:evil] at @s run damage @s 10000 magic by @e[limit=1,tag=evilwavesound]
...
execute as @e[tag=evilwavesound] at @s run effect give @s unluck infinite 5 true
execute as @e[tag=evilwave] run schedule function bro:magic/wave_remove1 5